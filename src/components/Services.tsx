...
const services = [
  {
    ...
    description:
      "Office buildouts, retail spaces, and commercial projects delivered on time and on budget.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Custom homes, additions, and new builds with precision craftsmanship.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    title: "Renovations",
    description:
      "Kitchens, bathrooms, basements, interiors, and complete home renovations.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Infrastructure, site work, grading, utilities, and public works projects.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Licensed electrical, plumbing, and HVAC services for any project scope.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export default function Services() {
  return (
    <section id="services" className="py-28 md:py-36 bg-[#0a0a0a]/95 backdrop-blur-sm border-t border-white/[0.06]">
