...
const VALUES = [
  { n: "01", title: "Under Budget",         body: "We treat your money like our own. Aggressive value engineering and honest contingency planning mean no surprises at closeout." },
  { n: "02", title: "Ahead of Schedule",    body: "We build float into every schedule and protect it. Our reputation is built on delivering when we say we will." },
  { n: "03", title: "One Point of Contact", body: "Jonathan is on every project personally. Not an account manager. The person making decisions on your site." },
  { n: "04", title: "Customers for Life",   body: "Our business runs on repeat clients and referrals. We build relationships the same way we build structures. To last." },
];
      ...
      <section className="bg-[#f7f7f5] border-b border-[#e8e8e8]">
        <div className="max-w-7xl mx-auto px-6 py-24 md:py-36">
          <div className="max-w-3xl">
            ...
            <p className="text-[15px] text-[#666] leading-relaxed">
              That vertical integration means we catch problems before they happen, because we understand both the construction risks and the financial consequences. Better decisions, faster execution, and a project that performs the way you underwrote it.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
            {[
              ...
              <div key={state}>
                ...
                {areas.map((a) => <p key={a} className="text-[14px] text-[#666] mb-2.5">{a}</p>)}
              </div>
            ))}
          </div>
