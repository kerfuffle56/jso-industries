...
export const metadata: Metadata = {
  ...
  description:
    "Full-service real estate development and general contracting. From preconstruction through closeout across NY, CT, and NJ.",
};
...
const SERVICES = [
  {
    ...
    body: "We acquire land and existing assets, navigate entitlements, and execute ground-up development in Westchester and the broader tri-state market. Our projects are underwritten conservatively and executed with a builder's discipline — because we're the builder.",
  },
  {
    n: "02",
  ...
  },
  {
    ...
    body: "For owners who need a sophisticated project manager on their side. We coordinate subcontractors, manage schedules and budgets, and represent your interests throughout construction — start to finish.",
  },
  {
    n: "06",
    name: "Owner's Representative",
    body: "You're busy. We act as your eyes and ears on the project — reviewing contracts, approving pay applications, monitoring progress, and making sure your interests are protected at every stage.",
  },
];
...
const PROCESS = [
  {
    ...
    desc: "Budget, schedule, team assembly, permit strategy, and value engineering. We set the project up to succeed before a shovel hits the ground.",
  },
  {
    n: "02",
...
export default function ServicesPage() {
  return (
    <main className="pt-16">
      ...
      <section className="border-t border-[#e8e8e8]">
        <div className="max-w-7xl mx-auto">
          {SERVICES.map((s) => (
            <div
              key={s.n}
              className="grid grid-cols-1 md:grid-cols-[80px_1fr_1.4fr] gap-0 border-b border-[#e8e8e8] px-6 py-10 md:py-14 hover:bg-[#fdf9f9] transition-colors group"
            >
              ...
              <div className="md:pr-12 mb-3 md:mb-0">
                <h2 className="text-[20px] md:text-[24px] font-semibold text-[#111] leading-tight group-hover:text-[#bf2a2a] transition-colors">
                  {s.name}
                </h2>
              </div>
              <div>
      ...
      {/* ── PROCESS ── */}
      <section className="bg-[#f7f7f5] border-t border-[#e8e8e8]">
        <div className="max-w-7xl mx-auto px-6 py-24 md:py-36">
          ...
          <div className="border border-[#e0e0e0] bg-white">
            <div className="grid grid-cols-1 md:grid-cols-4">
              {PROCESS.map((step, i) => (
                <div
                  key={step.n}
                  className={`p-8 md:p-10 border-b md:border-b-0 border-[#e8e8e8] last:border-b-0 ${i < 3 ? "md:border-r" : ""}`}
                >
