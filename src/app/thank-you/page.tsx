  ...
  return (
    <main className="pt-16 min-h-screen flex items-center bg-white">
      <div className="max-w-7xl mx-auto px-6 py-32">
        ...
        <h1 className="text-[clamp(56px,8vw,100px)] font-light text-[#111] leading-[0.88] tracking-tight mb-8">Thank you.</h1>
        ...
        <Link href="/" className="inline-block text-[12px] tracking-[0.12em] uppercase text-[#111] border-b border-[#bf2a2a] pb-0.5 hover:text-[#bf2a2a] transition-colors">
          Back to Home
        </Link>
      </div>
    </main>
